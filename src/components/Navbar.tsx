    ...
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <motion.a
            ...
            className="px-5 py-2.5 bg-primary text-white text-sm font-bold rounded-xl shadow-lg shadow-primary/20 hover:bg-primary-light transition-all"
          >
            Hire Me
          </motion.a>
        </div>
      ...
      {isMobileMenuOpen && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="absolute top-full left-0 right-0 bg-background border-t border-gray-100/10 p-6 shadow-xl md:hidden"
        >
